...
$western_forest.addPath(
	newRoom("spell_casting_academy", "loc_academy.gif").setEnterCallback(
		function () {
			music.play("academy");
		},
	),
...
$academy_practice.addPath(
	newRoom("box", "item_box.png", { writable: true }).setEnterCallback(function (
		r,
		vt,
	) {
...
$academy_practice
	...
	.map(function (i) {
		i.setCmdEvent("mv").addState("mv", mv_sum);
	});

//EASTERN MOUNTAINS
man_sage = newRoom("mountain", "loc_mountains.gif").newPeople(
	"man_sage",
	"item_mysteryman.png",
);
...
$mountain.addPath(
	newRoom("cave", "loc_cave.gif").addPath(
...
$dark_corridor.addPath(
	newRoom("dank", "loc_darkroom.gif", { writable: true })
		.addCommand("mv")
		.addPath(
			newRoom("small_hole", undefined, { writable: true }).setCmdText(
				"cd",
