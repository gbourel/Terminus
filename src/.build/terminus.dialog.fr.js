...
export const dialog={pogen_alert:"%s traductions manquent, tape 'pogen' pour télécharger le fichier de traduction avec les nouvelles entrées.",
...
room_western_forest_text:"Tu es entré⋅e dans la forêt des Lutins. Le chemin semble mener à une école.\nUn panneau indique \"Académie d'informatique : Grande école de Sorcellerie du Grand Ordinateur. \"",
room_spell_casting_academy:"Académie",
...
item_western_forest_academy_direction_text:"Académie d'informatique : Grande école de Sorcellerie du Grand Ordinateur.\nÀ ne pas manquer aujourd'hui : Leçon d'initiation aux commandes !",
...
people_troll1_rm:"Le troll semble avoir été surpris, puis disparaît.\nTu ignore ce qu'il était et tu n'as déjà comme souvenir de lui qu'un bruit désagréable signifiant le moment ou tu l'as fait disparaître.",
